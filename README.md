...
---
Operador-IF-ELSE/ │ ├── index.html

▶️ Como Executar o Projeto:
---
- Clone este repositório: git clone https://github.com/Esdra-Fontes/Operador-IF-ELSE.git
- Acesse a pasta do projeto
- Abra o arquivo index.html em qualquer navegador web

📚 Aprendizados:
---
- Entender e aplicar a estrutura condicional if/else
- Organizar lógica de decisão em JavaScript
- Manipulação básica do DOM (se aplicável)
